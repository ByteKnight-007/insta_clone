...
ActiveRecord::Schema[7.0].define(version: 2023_08_09_103701) do
...
# Could not dump table "saas_rail_domestic_freight_invoice_details" because of following StandardError
